  ...
  return (
    <div className="min-h-screen bg-gradient-watercolor">
      ...
      <main className="container mx-auto px-4 pt-24 pb-16">
        ...
        >
          <div>
            <h1 className="text-4xl md:text-6xl font-bold mb-2 watercolor-text">
              {activeSection === 'dashboard' ? 'Admin Dashboard' : `${activeSection.charAt(0).toUpperCase() + activeSection.slice(1)} Management`}
            </h1>
            <p className="text-lg text-muted-foreground">
              {activeSection === 'dashboard' ? 'Manage teams, candidates, events, and results' : `Manage ${activeSection}`}
            </p>
          </div>
